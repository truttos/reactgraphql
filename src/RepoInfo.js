const RepoInfo = ({repo}) => {
    ...
    switch (repo.licenseInfo?.spdxId) {
        ...
        case "NOASSERTION":
            license = (
                <span className="px-1 py-1 ms-1 d-inline-block btn btn-sm btn-warning" style={{ fontSize: ".6em" }}>
        ...
        default:
            license = (
                <span className="px-1 py-1 ms-1 d-inline-block btn btn-sm btn-outline-success" style={{ fontSize: ".6em" }}>
                    {repo.licenseInfo.spdxId}
                </span>
            );
    }
